...
if "%DBConfigured%"=="0" (
	...
	sqlpackage /Action:Publish /SourceFile:"%DEPLOYMENT_SOURCE%\site\repository\Wutnu3\bin\Wutnu.Database.dacpac" /TargetConnectionString:"%SQLAZURECONNSTR_WutNuContext%"
) else (
	sqlpackage /Action:Update /SourceFile:"%DEPLOYMENT_SOURCE%\site\repository\Wutnu3\bin\Wutnu.Database.dacpac" /TargetConnectionString:"%SQLAZURECONNSTR_WutNuContext%"
)
