    ...
    public static class WutStorage
    {
        ...
        public static ServiceProperties ConfigureCors(bool forceConfig = false)
        {
            ...
            if (addRule || forceConfig)
            {
                ...
                //Add wildcard "GET" to support using this storage account for B2C custom UI hosting
                newProperties.Cors.CorsRules.Add(new CorsRule
                {
                    AllowedHeaders = new[] { "content-lenth" },
                    AllowedMethods = CorsHttpMethods.Get,
                    AllowedOrigins = new[] { "*" },
                    ExposedHeaders = new[] { "content-lenth" },
                    MaxAgeInSeconds = ruleWideOpenWriter.MaxAgeInSeconds
                });
